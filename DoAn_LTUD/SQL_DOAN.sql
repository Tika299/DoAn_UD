...
VALUES
('A0001', N'Học sinh giỏi', N'Thành tích học tập giỏi đạt 8 chấm trở lên với số môn học ít nhất là 3'),
('A0002', N'Học sinh khá', N'Nỗ lực trong học tập đạt 7 chấm trở lên với số môn học ít nhất là 3'),
('A0003', N'Học sinh xuất sắc', N'Thành tích học tập xuất sắc đạt 9 chấm trở lên với số môn học ít nhất là 3');
